...
exports.message_getByUsers = async (req, res) =>{
    ...
    const data = await Message.find( 
        { $or: [{_receiver: users._receiver}, {_sender: users._receiver}, {_receiver: users._sender}, {_sender: users._receiver}],} // Donde mi usuario 1 es el que envía y el 2 el que recibe 
